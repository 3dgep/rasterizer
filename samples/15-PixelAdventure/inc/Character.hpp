...
public:
    ...
    void addAnimation( std::string_view animName, sr::graphics::SpriteAnimation anim );
    ...
    const sr::graphics::SpriteAnimation& getAnimation( std::string_view animName ) const;
    ...
    /// <summary>
    /// Draw the character using the provided rasterizer.
    /// </summary>
    /// <param name="rasterizer">The rasterizer to use to render the character sprite to.</param>
    /// <param name="transform">The transform to apply.</param>
    void draw( sr::graphics::Rasterizer& rasterizer, const sr::math::Transform2D& transform ) const;

private:
    // A map of animation names to SpriteAnim(s)
    using AnimMap = std::map<std::string, sr::graphics::SpriteAnimation>;

    AnimMap                        anims;
    sr::graphics::SpriteAnimation* currentAnim = nullptr;
};
