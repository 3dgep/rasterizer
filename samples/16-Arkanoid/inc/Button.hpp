...
public:
    ...
    Button( std::string_view text, std::shared_ptr<const sr::graphics::Font> font, const sr::graphics::Color& color = sr::graphics::Color::White, const sr::math::RectF& rect = sr::math::RectF {}, std::function<void()> onClick = {} );
