...
std::shared_ptr<SpriteSheet> ResourceManager::loadSpriteSheet( const std::filesystem::path& filePath, uint32_t rows, uint32_t columns, uint32_t padding, uint32_t margin, const BlendMode& blendMode )
{
